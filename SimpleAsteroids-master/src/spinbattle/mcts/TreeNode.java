...
public class TreeNode
{
    ...
    public TreeNode(int ROLLOUT_DEPTH, double REWARD_DISCOUNT, Random rnd, int[] NUM_ACTIONS, Types.ACTIONS[][] actions, int id, int oppID, int no_players) {
        this(null, -1, rnd, ROLLOUT_DEPTH, REWARD_DISCOUNT, id, oppID, no_players, NUM_ACTIONS, actions);
    }

    public TreeNode(TreeNode parent, int childIdx, Random rnd, int ROLLOUT_DEPTH, double REWARD_DISCOUNT, int id, int oppID, int no_players, int[] NUM_ACTIONS, Types.ACTIONS[][] actions) {
        this.id = id;
        this.oppID = oppID;
...
//        System.out.println("N Players = " + no_players);
//        System.out.println(Arrays.toString(acts));
        ...
        TreeNode tn = new TreeNode(this,bestAction,this.m_rnd, this.ROLLOUT_DEPTH, this.REWARD_DISCOUNT, id, oppID, no_players, NUM_ACTIONS, actions);
    ...
    public double value(StateObservationMulti a_gameState) {
        ...
        return rawScore * Math.pow(REWARD_DISCOUNT, m_depth);
    }
    ...
    public int mostVisitedAction() {
        ...
        for (int i=0; i<children.length; i++) {
            ...
            if(children[i] != null)
            {
                ...
                System.out.println("Child is null: " + i);
            }
        }
        ...
        if (selected == -1)
        {
            ...
            System.out.println("n fails = " + nMisses++);
            selected = 0;
        }else if(allEqual)
        {
